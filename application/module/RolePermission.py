...
class RolePermission:
    ...
    def ToggleRoleActiveStatus(cls, role_id: int):
        ...
        try:
            ...
            db.session.commit()
            Audit.add_audit('Changed Role status', current_user, _role.to_dict(add_filter=False))
    ...
    def AddRole(cls, role_name, description):
        try:
            ...
            Audit.add_audit('Added Role', current_user, new_role.to_dict(add_filter=False))
    ...
    def UpdateRole(cls, role_id, role_name, description):
        ...
        try:
            ...
            db.session.commit()
            Audit.add_audit('Updated Role Information', current_user, _role.to_dict(add_filter=False))
    ...
    def DeleteRole(cls, role_id):
        ...
        try:
            Audit.add_audit('Deleted Role', current_user, _role.to_dict(add_filter=False))
            db.session.commit()
    ...
    def AssignPermissionToRole(cls, role_id, permission_id):
        ...
        try:
            ...
            db.session.commit()
            Audit.add_audit('Assigned permission to Role', current_user, _role.to_dict(add_filter=False))
    ...
    def RemovePermissionFromRole(cls, role_id, permission_id):
        ...
        try:
            Audit.add_audit('Removed permission from role', current_user, _role.to_dict(add_filter=False))
