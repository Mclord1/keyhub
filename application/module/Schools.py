...
class SchoolModel:
    ...
    def list_all_schools(cls, page, per_page):
        ...
        pagination_data = {
            ...
            "results": [{
                "num_of_teachers": len(school.teachers),
                "num_of_students": len(school.students),
                "num_of_parents": len(school.parents),
                "num_of_school_administrators": len(school.managers),
    ...
    def get_account_admins(cls, school_id):
        ...
        return {
            ...
            "admins": [{
                "role": [x.name for x in x.user.roles],
                "email": x.user.email,
